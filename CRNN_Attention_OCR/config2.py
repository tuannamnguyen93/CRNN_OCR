...
LOGS_PATH = 'log'
CKPT_DIR = 'save_model'
train_dir='Synthetic Chinese String Dataset_2/images'
val_dir='Synthetic Chinese String Dataset_2/images'
is_restore=True
...
def read_data_train(data_dir,file,from_index,to_index ):
    image = []
    labels = []
    num=0
