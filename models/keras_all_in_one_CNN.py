...
def get_data(a,b):
    ...
    return arr1, arr2,np.ones((b-a,1))*291,np.ones((b-a,1))*20, ratio
...
def model():
    ...
    output_with_ts = Lambda(skip_time, name = "skip_time")(output)

    lstm_1=LSTM(128,return_sequences=True,kernel_initializer='he_normal',name='lstm1')(output_with_ts)

    lstm_1b=LSTM(128,return_sequences=True,go_backwards=True,kernel_initializer='he_normal',name='lstm1b')(output_with_ts)
...
def train_model():
    ...
    for epoch in range(0,5):
        ...
        for i in range(0,20):
            ...
            m.fit([input_data, labels, input_length, labels_length], Y, batch_size=96)

	    m.save_weights("model_CNN.hdf5")
