...
def get_data(a,b):
    ...
    return arr1, arr2,np.ones((b-a,1))*548,np.ones((b-a,1))*20
...
def train_model():
    ...
    m.load_weights("model6.hdf5",by_name=True)
...
#    sys.exit(0)
    ...
    #img = cv2.imread("../data/Seq_data_20_all_same_train/" + "Sequence_" + "110" + ".png")
    #img = cv2.resize(img,(581,32))
